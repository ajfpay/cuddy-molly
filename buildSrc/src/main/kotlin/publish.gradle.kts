    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/ajfpay/cuddymolly/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/ajfpay/cuddymolly.git")
                    developerConnection.set("scm:git:ssh://github.com/ajfpay/cuddymolly.git")
                    url.set("https://github.com/ajfpay/cuddymolly/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/ajfpay/cuddymolly/issues")
                }
            }
        }
    }
